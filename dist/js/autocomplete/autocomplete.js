...
/***/ function(module, exports, __webpack_require__) {
	...
	const CSS = _autocomplete2.default.toString(); /**
	                                                * Imports the Sass file, and converts it to a css string for use in the
	                                                * web component's template.
	                                                */
	var HTML = '<div id="content">\n    <input type="text" placeholder="Search for a person" id="auto_complete_list">\n    <img id="dropdown_btn" src="/images/arrow.svg"/>\n    <br>\n    <select size="4" id="result_container" class="hide">\n    </select>\n</div>\n';
...
/***/ function(module, exports, __webpack_require__) {
	...
	// imports
	exports.push([module.id, "@import url(/css/base.css);", ""]);
	
	// module
	exports.push([module.id, ":host {\n  font-family: va(--ff-main);\n  background-color: var(--c-white);\n  position: relative; }\n\n#content .hide {\n  display: none; }\n\n#content .show {\n  display: inline; }\n\n#content #auto_complete_list, #content .auto_complete_list {\n  background-image: url(/images/search.svg);\n  background-position: 12px 11px;\n  background-repeat: no-repeat;\n  padding-left: 54px;\n  padding-right: 54px;\n  background-size: 40px;\n  width: 245px; }\n  #content #auto_complete_list:focus, #content #auto_complete_list:active, #content .auto_complete_list:focus, #content .auto_complete_list:active {\n    border: solid 2px #6699cc; }\n\n#content #dropdown_btn, #content .dropdown_btn {\n  position: relative;\n  width: 50px;\n  height: 60px;\n  right: 50px;\n  top: 25px; }\n\n#content #result_container, #content .ul_tag {\n  position: relative;\n  top: -2px;\n  right: 8px;\n  border: solid 0px #fff;\n  width: 315px;\n  max-height: 250px;\n  border-top: solid 0px #000;\n  box-shadow: -3px 3px 3px #bbb4b4; }\n\n#content #result_container option {\n  width: 100%;\n  height: 45px;\n  color: #000000;\n  padding: 15px 15px 0px 85px;\n  background-size: 38px;\n  background-repeat: no-repeat;\n  /* Do not repeat the icon image */\n  text-transform: capitalize;\n  background-attachment: initial;\n  background-position: 10px; }\n  #content #result_container option:nth-child(odd) {\n    background-color: #f0ffff;\n    background-attachment: initial;\n    background-position: 10px; }\n", ""]);
